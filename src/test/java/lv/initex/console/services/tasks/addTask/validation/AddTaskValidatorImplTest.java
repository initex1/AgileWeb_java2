...
public class AddTaskValidatorImplTest {
    ...
    public void shouldReturnCollectAndReturnErrors() {
        ...
        Mockito.when(emptyTitleRule.execute("homework1"))
                .thenReturn(Optional.of(new TaskListError("title", "empty Title")));
        ...
        assertEquals(errors.get(0).getDescription(),"duplicate");
        assertEquals(errors.get(1).getDescription(),"empty Title");
    }
}